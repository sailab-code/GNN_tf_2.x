...
class LGNN(BaseGNN):
    ...
    # -----------------------------------------------------------------------------------------------------------------
    def predict(self, g: Union[GraphObject, GraphTensor], idx: Union[int, list[int], range] = -1) -> Union[tf.Tensor, list[tf.Tensor]]:
    ...
    def evaluate_single_graph(self, g: Union[GraphObject, GraphTensor], class_weights: Union[float, list[float]], training: bool) -> tuple:
        ...
        :param g: (GraphObject or GraphTensor) single GraphObject element
